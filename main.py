...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_test_preds', default=SAVE_TEST_PREDICTIONS, type=bool,
                        help='save predictions in separate file')
    ...
    parser.add_argument('--save_model', default=SAVE_MODEL, type=bool,
                        help='whether to save the trained model as a pickle file')
